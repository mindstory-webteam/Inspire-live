...
// FIX: moved styles outside component to avoid re-injection on every render
const STYLES = `
  .magazine-wrapper {
    background: #ecf0f0;
  ...
  .state-text { font-size: 18px; color: #1a425c; font-weight: 600; }
  .retry-btn {
    padding: 10px 28px;
    background: #1a598a;
    color: #fff;
  ...
  .page-info { font-size: 13px; color: #67787a; font-weight: 600; margin-left: 12px; }
  @keyframes fadeIn {
...
const UniversityEventsMagazine = () => {
  ...
  return (
    <>
      {/* FIX: standard <style> tag works in App Router; style jsx does not */}
