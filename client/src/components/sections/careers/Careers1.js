...
const CareerDetails1 = ({ career, prevId, nextId, isPrevItem, isNextItem }) => {
	const {
		_id, title, image, category, need, location,
						...
						<div className="tj-post-wrapper">
							<div className="tj-post-single-post">
								...
								<div className="tj-careers-top mb-30">
									{/* ── IMAGE replaces icon ── */}
									<div className="tj-careers-top-icon" style={{ overflow: "hidden", borderRadius: 12, flexShrink: 0 }}>
										{image?.url ? (
											<img
												src={image.url}
												alt={title || "Career"}
											...
											<div style={{
												...
												background: "#f1f5f9", color: "#94a3b8", fontSize: 32,
											}}>
												💼
											</div>
										)}
