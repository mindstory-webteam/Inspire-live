...
/* ─── API ───────────────────────────────────────────────────────────────── */
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://inspireeducationservice.com/api';
...
function VideoPlayer({ videoUrl, popupVideo, videoImg }) {
  ...
  if (!src) return null;
  const embedSrc = src.includes('watch?v=') ? src.replace('watch?v=', 'embed/').split('&')[0] : src.includes('youtu.be/') ? 'https://www.youtube.com/embed/' + src.split('youtu.be/')[1].split('?')[0] : src;
  return (
...
=======
        .bd-title{font-family:inherit;font-size:clamp(1.7rem,4vw,2.4rem);font-weight:700;color:var(--td);line-height:1.3;margin-bottom:28px;}
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
        .bd-body h1,.bd-body h2,.bd-body h3{color:var(--td);margin:32px 0 14px;}
=======
        .bd-body h1,.bd-body h2,.bd-body h3{font-family:inherit;color:var(--td);margin:32px 0 14px;}
>>>>>>> Stashed changes
...
=======
        .bd-quote p{font-family:inherit;font-style:italic;font-size:1.12rem;color:var(--td);line-height:1.75;margin:0;}
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
        .bd-author-name{font-size:1.05rem;font-weight:700;color:var(--td);margin-bottom:2px;}
=======
        .bd-author-name{font-family:inherit;font-size:1.05rem;font-weight:700;color:var(--td);margin-bottom:2px;}
>>>>>>> Stashed changes
        ...
        /* COMMENTS */
<<<<<<< Updated upstream
        .bd-section-title{font-size:1.25rem;font-weight:700;color:var(--td);margin:0 0 24px;padding-bottom:12px;border-bottom:2px solid var(--tbr5);}
=======
        .bd-section-title{font-family:inherit;font-size:1.25rem;font-weight:700;color:var(--td);margin:0 0 24px;padding-bottom:12px;border-bottom:2px solid var(--tbr5);}
>>>>>>> Stashed changes
        ...
        .bd-input,.bd-textarea{width:100%;padding:12px 16px;border:1.5px solid var(--tg2);border-radius:10px;font-size:.88rem;color:var(--td);outline:none;transition:border-color .2s,background .2s;background:var(--tg1);}
        ...
        .bd-submit-btn{background:var(--tp);color:#fff;padding:13px 36px;border:none;border-radius:100px;font-size:.9rem;font-weight:600;cursor:pointer;transition:background .2s,transform .15s;}
...
<<<<<<< Updated upstream
        .bd-sidebar-title{font-size:1rem;font-weight:700;color:var(--td);margin:0 0 18px;padding-bottom:10px;border-bottom:2px solid var(--tbr5);}
=======
        .bd-sidebar-title{font-family:inherit;font-size:1rem;font-weight:700;color:var(--td);margin:0 0 18px;padding-bottom:10px;border-bottom:2px solid var(--tbr5);}
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
        .bd-error-title{font-size:1.25rem;color:#7b2020;margin-bottom:8px;}
=======
        .bd-error-title{font-family:inherit;font-size:1.25rem;color:#7b2020;margin-bottom:8px;}
>>>>>>> Stashed changes
