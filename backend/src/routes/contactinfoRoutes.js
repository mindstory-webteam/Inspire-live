...
const ContactMenu = ({ isContactOpen, setIsContactOpen }) => {
  ...
  const handleClick = () => setIsContactOpen(false);
  ...
  return (
    <>
      <div
        ...
        onClick={handleClick}
      />
      <div className={`tj-offcanvas-area d-none d-lg-block ${isContactOpen ? "opened" : ""}`}>
        ...
        <div className="hamburger_wrapper">
          <div className="hamburger_inner">
            ...
            <div className="offcanvas-text"><p></p></div>
          ...
          <div className="hamburger-socials">
            ...
            <div className="social-links style-3">
              <ul>
                <li><a href="https://www.facebook.com/inspireeducationservice/" target="_blank"><i className="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="https://www.instagram.com/inspireeducationservice/" target="_blank"><i className="fa-brands fa-instagram"></i></a></li>
                <li><a href="https://www.youtube.com/channel/UCxdf2JpHcvAuGhVweQiy6GA?app=desktop" target="_blank"><i className="fa-brands fa-youtube"></i></a></li>
